...
Le plancton est un élément majeur des écosystèmes marins. Le suivi de la dynamique du plancton est un enjeu capital.
...
Le jeu de données WHOI commprend 6600 images avec un set d'apprentissage associé de 22 catégories avec 300 items par groupe. Ces dimage sont obtenue via le FlowCytobot.
