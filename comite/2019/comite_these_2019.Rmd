...
L'études des réponses écophysiologiques des coraux à des stress par des méthodes non destructives et en mésocosmes (limite du nombre d'individus), requiert l'utilisation de techniques et d'outils particuliers. 

L'apprentissage et la mise au point d'un [analyseur de nutriments](https://github.com/EcoNum/protocol_seal_aa3) (Seal AA3, dosage des composés azotés et phosphorés), d'une microsonde à oxygène (Pyrosciences Sensor, mesure locale de l'oxygène), de chambres respiromètriques (mesure globale de l'oxygène), d'un fluoromètre (Imaging-Pam, quantification de la fluorescence émise par la chlorophylle), et enfin du [suivi de la croissance via le poids immergé](https://github.com/EcoNum/coral_growth001) sont les premiers outils et techniques que j'ai utilisé.
